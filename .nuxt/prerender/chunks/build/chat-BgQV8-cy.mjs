import { ref, watch, nextTick, mergeProps, useSSRContext } from 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/vue/server-renderer/index.mjs';
import { p as publicAssetsURL } from '../_/renderer.mjs';
import { _ as _export_sfc } from './server.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/h3/dist/index.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/ufo/dist/index.mjs';
import '../_/nitro.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/destr/dist/index.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/hookable/dist/index.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/ofetch/dist/node.mjs';
...
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/defu/dist/defu.mjs';
...
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/unctx/dist/index.mjs';
import 'file://F:/SITE/lycee-europe/lycee-europe/node_modules/vue-router/vue-router.node.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isAuthenticated.value) {
        ...
        _push(`<div class="flex-1 flex flex-col max-w-5xl w-full mx-auto p-4 md:p-6 z-10 relative h-screen" data-v-b5c828cf><div class="flex-1 flex flex-col bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-hidden" data-v-b5c828cf><header class="px-6 py-5 border-b border-white/5 bg-black/20 flex justify-between items-center shrink-0" data-v-b5c828cf><div class="flex items-center gap-4" data-v-b5c828cf><div class="w-3 h-3 rounded-full bg-violet-500 shadow-[0_0_10px_rgba(139,92,246,0.8)] animate-pulse" data-v-b5c828cf></div><div data-v-b5c828cf><h1 class="text-xl font-bold text-white tracking-wide" data-v-b5c828cf>NEXUS<span class="text-violet-500" data-v-b5c828cf>_COMMS</span></h1><p class="text-xs text-violet-300/60 mt-0.5 font-mono" data-v-b5c828cf>R\xE9seau chiffr\xE9. <span class="text-violet-400" data-v-b5c828cf>/help</span> pour l&#39;aide.</p></div></div><button class="text-xs font-mono text-violet-300/50 hover:text-red-400 transition-colors uppercase tracking-widest px-3 py-2 rounded-lg hover:bg-white/5" data-v-b5c828cf> D\xE9connexion </button></header><div class="flex-1 overflow-y-auto overflow-x-hidden flex flex-col gap-6 p-6 custom-scrollbar" data-v-b5c828cf><!--[-->`);
        ssrRenderList(messages.value, (msg) => {
          ...
          if (msg.imageUrl && msg.imageUrl.startsWith("https://")) {
            _push(`<img${ssrRenderAttr("src", msg.imageUrl)} class="max-w-sm w-full rounded-xl mb-3 border border-white/10 shadow-md" alt="M\xE9dia" data-v-b5c828cf>`);
          } else {
            _push(`<!---->`);
          }
          if (msg.text) {
        ...
        _push(`<!--]--></div><form class="p-4 bg-black/20 border-t border-white/5 flex gap-3 shrink-0 items-center" data-v-b5c828cf><button type="button" class="w-11 h-11 flex items-center justify-center rounded-xl bg-white/5 text-violet-300 hover:bg-violet-500/30 hover:text-white transition-all border border-white/5" title="Joindre une image" data-v-b5c828cf><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5c828cf><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" data-v-b5c828cf></path></svg></button><input${ssrRenderAttr("value", newMessage.value)} type="text" maxlength="500" placeholder="\xC9crire un message..." class="flex-1 bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-violet-500 focus:bg-white/10 focus:ring-1 focus:ring-violet-500 outline-none transition-all placeholder-violet-300/30" data-v-b5c828cf><input type="file" accept="image/*" class="hidden" data-v-b5c828cf><button type="submit" class="h-11 px-6 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-medium transition-all shadow-[0_0_15px_rgba(124,58,237,0.4)] flex items-center gap-2" data-v-b5c828cf><span class="hidden md:inline" data-v-b5c828cf>Envoyer</span><svg class="w-4 h-4 md:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b5c828cf><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" data-v-b5c828cf></path></svg></button></form></div></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=chat-BgQV8-cy.mjs.map
