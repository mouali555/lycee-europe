...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.DO707mqY.mjs').then(interopDefault),
  "pages/chat.vue": () => import('./_nuxt/chat-styles.BTl3GRzT.mjs').then(interopDefault),
  "pages/nexus.vue": () => import('./_nuxt/nexus-styles.Cl_GgOgW.mjs').then(interopDefault),
  "pages/chat.vue?vue&type=style&index=0&scoped=1b7b8453&lang.css": () => import('./_nuxt/chat-styles.BTl3GRzT.mjs').then(interopDefault),
  "pages/nexus.vue?vue&type=style&index=0&scoped=0daba3f3&lang.css": () => import('./_nuxt/nexus-styles.Cl_GgOgW.mjs').then(interopDefault),
